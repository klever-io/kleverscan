...
describe('Component: Footer', () => {
  ...
  it('Should render the footer with the Klever logo and description', () => {
    const footerDesc = 'Klever Explorer is our main platform to visualize assets, blocks, nodes, accounts and transactions in an intuitive and interactive manner. Everything happening in KleverChain can be consulted here on our Explorer.';
  ...
  it('Should render all social media links and each should have the correct address to Klever\'s socials pages', () => {
    const getSocials = container.firstChild?.firstChild?.childNodes[2]?.childNodes;
