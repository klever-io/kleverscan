          ...
          <Container $opened={opened}>
            ...
            <BodyModal>
              ...
              <p>
                ...
                blockchain applications. It is a non-custodial wallet to
                anonymously store crypto-assets and connect to applications from
                multiple blockchains including Bitcoin (BTC), Ethereum (ETH),
                BSC (BNB), KleverChain (KLV) and Tron (TRX).
              </p>
              <p>
              ...
              <p>
                <strong>Step 4</strong>: Once you have created a wallet, you can
                start using Klever Extension to connect to web applications and
                create transactions.
              </p>
              <p>
                Reload the page and click the <strong>Connect</strong> button to
                connect your wallet.
              </p>
              <br />
              <p>
                ...
                <a
                  href="http://support.klever.io/hc/en-us/requests/new"
                  rel="nofollow"
                >
