        ...
        <CardTabContainer>
            ...
            <CardContent>
                ...
                <Row>
                    <span>To</span>
                    <CenteredRow>
                        {contract && contract.length > 0 && contract[0].parameter?.address &&
                            (
                                <>
                                    <span>{parseAddress(contract[0].parameter?.address, isMobile ? 35 : NaN)}</span>
                ...
                <Row>
                    <span>Method</span>
                    <CenteredRow>
                        {contract && contract.length > 0 && contract[0].parameter?.type &&
